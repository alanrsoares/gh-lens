...
/** An account to manage multiple organizations with consolidated policy and billing. */
export interface EnterpriseUserAccountsArgs {
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
/** Enterprise information only visible to enterprise owners. */
export interface EnterpriseOwnerInfoPendingCollaboratorsArgs {
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
/** A user with an invitation to be a collaborator on a repository owned by an organization in an enterprise. */
export interface EnterprisePendingCollaboratorEdgeRepositoriesArgs {
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
/** The root query for implementing GraphQL mutations. */
export interface MutationCreateContentAttachmentArgs {
...
export interface Organization extends Actor, MemberStatusable, Node, PackageOwner, ProfileOwner, ProjectOwner, RepositoryOwner, Sponsorable, UniformResourceLocatable {
...
/** The query root of GitHub's GraphQL interface. */
export interface QuerySponsorsListingArgs {
  slug: Scalars['String'];
}
...
export interface Repository extends Node, PackageOwner, ProjectOwner, RepositoryInfo, Starrable, Subscribable, UniformResourceLocatable {
...
export interface User extends Actor, Node, PackageOwner, ProfileOwner, ProjectOwner, RepositoryOwner, Sponsorable, UniformResourceLocatable {
  /** Determine if this repository owner has any items that can be pinned to their profile. */
  anyPinnableItems: Scalars['Boolean'];
...
export type ViewerQuery = { viewer: (
    Pick<User, 'login' | 'name' | 'bio' | 'email' | 'location' | 'avatarUrl' | 'websiteUrl' | 'company'>
    & { followers: Pick<FollowerConnection, 'totalCount'>, repositories: Pick<RepositoryConnection, 'totalCount'> }
  ) };
...
export type ViewerPopularRepositoriesQuery = { viewer: (
    Pick<User, 'login'>
    & { repositories: { nodes?: Maybe<Array<Maybe<(
        Pick<Repository, 'name' | 'description' | 'stargazerCount' | 'viewerCanAdminister'>
        & { languages?: Maybe<{ nodes?: Maybe<Array<Maybe<Pick<Language, 'name' | 'color'>>>> }> }
      )>>> } }
  ) };
...
export const useViewerQuery = <
    ...
    useQuery<ViewerQuery, TError, TData>(
      ['viewer', variables],
      fetcher<ViewerQuery, ViewerQueryVariables>(client, ViewerDocument, variables),
      options
    );
export const ViewerPopularRepositoriesDocument = `
...
export const useViewerPopularRepositoriesQuery = <
    ...
    useQuery<ViewerPopularRepositoriesQuery, TError, TData>(
      ...
      fetcher<ViewerPopularRepositoriesQuery, ViewerPopularRepositoriesQueryVariables>(client, ViewerPopularRepositoriesDocument, variables),
      options
    );